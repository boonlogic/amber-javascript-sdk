...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FusionConfig', function() {
      beforeEach(function() {
        instance = new AmberApiServer.FusionConfig();
      });

      it('should create an instance of FusionConfig', function() {
        // TODO: update the code to test FusionConfig
        expect(instance).to.be.a(AmberApiServer.FusionConfig);
      });
