...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmberApiServer.GetSensorResponseUsageInfoGetConfig();
  });
  ...
  describe('GetSensorResponseUsageInfoGetConfig', function() {
    it('should create an instance of GetSensorResponseUsageInfoGetConfig', function() {
      // uncomment below and update the code to test GetSensorResponseUsageInfoGetConfig
      //var instane = new AmberApiServer.GetSensorResponseUsageInfoGetConfig();
      //expect(instance).to.be.a(AmberApiServer.GetSensorResponseUsageInfoGetConfig);
    });
