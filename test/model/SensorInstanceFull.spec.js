...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmberApiServer.SensorInstanceFull();
  });
  ...
  describe('SensorInstanceFull', function() {
    it('should create an instance of SensorInstanceFull', function() {
      // uncomment below and update the code to test SensorInstanceFull
      //var instane = new AmberApiServer.SensorInstanceFull();
      //expect(instance).to.be.a(AmberApiServer.SensorInstanceFull);
    });
