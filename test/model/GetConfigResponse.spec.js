...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetConfigResponse', function() {
      beforeEach(function() {
        instance = new AmberApiServer.GetConfigResponse();
      });

      it('should create an instance of GetConfigResponse', function() {
        // TODO: update the code to test GetConfigResponse
        expect(instance).to.be.a(AmberApiServer.GetConfigResponse);
      });
      ...
      it('should have the property percentVariation (base name: "percentVariation")', function() {
        // TODO: update the code to test the property percentVariation
        expect(instance).to.have.property('percentVariation');
        // expect(instance.percentVariation).to.be(expectedValueLiteral);
      });
