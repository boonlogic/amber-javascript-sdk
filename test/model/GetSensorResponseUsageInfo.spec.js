...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmberApiServer.GetSensorResponseUsageInfo();
  });
  ...
  describe('GetSensorResponseUsageInfo', function() {
    it('should create an instance of GetSensorResponseUsageInfo', function() {
      // uncomment below and update the code to test GetSensorResponseUsageInfo
      //var instane = new AmberApiServer.GetSensorResponseUsageInfo();
      //expect(instance).to.be.a(AmberApiServer.GetSensorResponseUsageInfo);
    });
