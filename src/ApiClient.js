...
export class ApiClient {
    ...
    constructor() {
         ...
         * @type {String}
         * @default http://amber.boonlogic.com/v1
         */
        this.basePath = 'http://amber.boonlogic.com/v1'.replace(/\/+$/, '');
        ...
        /*
         * Configure a proxy if defined in environment
         */
        this.proxy = process.env.http_proxy || process.env.HTTP_PROXY || process.env.https_proxy || process.env.HTTPS_PROXY || null
    ...
    callApi(path, httpMethod, pathParams,
        ...
        // disable tls cert verification if required
        if (!this.verifyTLS) {
