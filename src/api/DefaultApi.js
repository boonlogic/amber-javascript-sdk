...
export class DefaultApi {
    ...
    */
     ...
     * @param {String} opts.pretrainAsync Internal header for async lambda processing
    ...
    postPretrainWithHttpInfo(body, sensorId, opts) {
      ...
      let headerParams = {
        'sensorId': sensorId,'amberChunk': opts['amberChunk'],'amberTransaction': opts['amberTransaction'],'pretrain-async': opts['pretrainAsync']
      };
      let formParams = {
